/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-fuerte-turtlebot-1.0.2/debian/ros-fuerte-turtlebot/opt/ros/fuerte/stacks/turtlebot/turtlebot_node/msg/TurtlebotSensorState.msg */
#ifndef TURTLEBOT_NODE_MESSAGE_TURTLEBOTSENSORSTATE_H
#define TURTLEBOT_NODE_MESSAGE_TURTLEBOTSENSORSTATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TurtlebotSensorState_ {
  ...
  typedef boost::shared_ptr< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TurtlebotSensorState
typedef  ::turtlebot_node::TurtlebotSensorState_<std::allocator<void> > TurtlebotSensorState;

typedef boost::shared_ptr< ::turtlebot_node::TurtlebotSensorState> TurtlebotSensorStatePtr;
typedef boost::shared_ptr< ::turtlebot_node::TurtlebotSensorState const> TurtlebotSensorStateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "d8f8ec7fa031fc9cc88e8319cd08a785";
  }

  static const char* value(const  ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xd8f8ec7fa031fc9cULL;
  static const uint64_t static_value2 = 0xc88e8319cd08a785ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "turtlebot_node/TurtlebotSensorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::turtlebot_node::TurtlebotSensorState_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // TURTLEBOT_NODE_MESSAGE_TURTLEBOTSENSORSTATE_H
