/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-fuerte-turtlebot-1.0.2/debian/ros-fuerte-turtlebot/opt/ros/fuerte/stacks/turtlebot/turtlebot_node/msg/RoombaSensorState.msg */
#ifndef TURTLEBOT_NODE_MESSAGE_ROOMBASENSORSTATE_H
#define TURTLEBOT_NODE_MESSAGE_ROOMBASENSORSTATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct RoombaSensorState_ {
  ...
  typedef boost::shared_ptr< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtlebot_node::RoombaSensorState_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct RoombaSensorState
typedef  ::turtlebot_node::RoombaSensorState_<std::allocator<void> > RoombaSensorState;

typedef boost::shared_ptr< ::turtlebot_node::RoombaSensorState> RoombaSensorStatePtr;
typedef boost::shared_ptr< ::turtlebot_node::RoombaSensorState const> RoombaSensorStateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::turtlebot_node::RoombaSensorState_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::RoombaSensorState_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "9e8632c0937537603a670e96e85cd991";
  }

  static const char* value(const  ::turtlebot_node::RoombaSensorState_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x9e8632c093753760ULL;
  static const uint64_t static_value2 = 0x3a670e96e85cd991ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "turtlebot_node/RoombaSensorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::turtlebot_node::RoombaSensorState_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::turtlebot_node::RoombaSensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::turtlebot_node::RoombaSensorState_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // TURTLEBOT_NODE_MESSAGE_ROOMBASENSORSTATE_H
