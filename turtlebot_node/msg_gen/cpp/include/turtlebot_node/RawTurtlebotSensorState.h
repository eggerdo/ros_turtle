/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-fuerte-turtlebot-1.0.2/debian/ros-fuerte-turtlebot/opt/ros/fuerte/stacks/turtlebot/turtlebot_node/msg/RawTurtlebotSensorState.msg */
#ifndef TURTLEBOT_NODE_MESSAGE_RAWTURTLEBOTSENSORSTATE_H
#define TURTLEBOT_NODE_MESSAGE_RAWTURTLEBOTSENSORSTATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct RawTurtlebotSensorState_ {
  ...
  typedef boost::shared_ptr< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct RawTurtlebotSensorState
typedef  ::turtlebot_node::RawTurtlebotSensorState_<std::allocator<void> > RawTurtlebotSensorState;

typedef boost::shared_ptr< ::turtlebot_node::RawTurtlebotSensorState> RawTurtlebotSensorStatePtr;
typedef boost::shared_ptr< ::turtlebot_node::RawTurtlebotSensorState const> RawTurtlebotSensorStateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "103d192c45e953c8bb1c3c046e89e2ff";
  }

  static const char* value(const  ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x103d192c45e953c8ULL;
  static const uint64_t static_value2 = 0xbb1c3c046e89e2ffULL;
};

template<class ContainerAllocator>
struct DataType< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
    return "turtlebot_node/RawTurtlebotSensorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::turtlebot_node::RawTurtlebotSensorState_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // TURTLEBOT_NODE_MESSAGE_RAWTURTLEBOTSENSORSTATE_H
