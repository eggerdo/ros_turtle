...
(cl:defmethod cl:initialize-instance :after ((m <BatteryState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_node-msg:<BatteryState> is deprecated: use turtlebot_node-msg:BatteryState instead.")))
...
(cl:defmethod temperature-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_node-msg:temperature-val is deprecated.  Use turtlebot_node-msg:temperature instead.")
  (temperature m))
